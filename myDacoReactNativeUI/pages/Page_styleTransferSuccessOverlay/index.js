...
export const Page_styleTransferSuccessOverlay = ({ route, navigation }) => {
	...
	return (
		<ScrollView style={{width: Dimensions.get("window").width, height: Dimensions.get("window").height, backgroundColor: "rgba(255, 255, 255, 1)"}} horizontal = {false} showsVerticalScrollIndicator={false} showsHorizontalScrollIndicator={false} bounces={false}>
			<View style={{width: Dimensions.get("window").width, height: 119}} >
				<View style = {stylesheet.styleStylename}>
					<Text style = {stylesheet.styleJohnDoeWasSuccessfullyTransferredFromPlane1Manifest_}>
						John Doe was successfully transferred from Plane 1 Manifest.
					</Text>
...
const stylesheet = StyleSheet.create({
 	styleJohnDoeWasSuccessfullyTransferredFromPlane1Manifest_: {
		position: "absolute",
		left: 0,
		top: 19,
		width: 402,
