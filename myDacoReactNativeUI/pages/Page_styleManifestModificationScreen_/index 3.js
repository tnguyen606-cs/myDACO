...
export const Page_styleManifestModificationScreen_ = ({ route, navigation }) => {
			...
			<View style={{width: Dimensions.get("window").width, height: 786}} >
				<View style = {stylesheet.styleStylename}>
					...
					<View style = {stylesheet.stylePersonnelPanel}>
						...
						<View style = {stylesheet.styleGroup10}>
							...
							<View style = {stylesheet.styleIcons8People6412}>
								<Image style = {stylesheet.styleIcons8People641} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/y5MovIW9fojO4JQrcIUemvaR.png"}}/>
							</View>
						</View>
						<View style = {stylesheet.styleGroup9}>
							<View style = {stylesheet.styleIcons8People6412Copy1}>
								<Image style = {stylesheet.styleIcons8People641Copy1} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/LII413t8lyGMQpFlFGA33rpy.png"}}/>
							</View>
						...
						<View style = {stylesheet.styleGroup8}>
							...
							<View style = {stylesheet.styleIcons8People6412Copy2}>
								<Image style = {stylesheet.styleIcons8People641Copy2} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/EM5XxiulH5hPE7Hf1TRjce9w.png"}}/>
							</View>
						</View>
						<View style = {stylesheet.styleGroup7}>
							...
							<View style = {stylesheet.styleIcons8People6412Copy3}>
								<Image style = {stylesheet.styleIcons8People641Copy3} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/Q7osyZyb16X1yEXJQN4G8Mkn.png"}}/>
							</View>
						</View>
						<View style = {stylesheet.styleGroup6}>
							...
							<View style = {stylesheet.styleIcons8People6412Copy4}>
								<Image style = {stylesheet.styleIcons8People641Copy4} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/lkfL7KS9Renz2tQ0d1E0QW1w.png"}}/>
							</View>
						</View>
						<View style = {stylesheet.styleGroup5}>
							...
							<View style = {stylesheet.styleIcons8People6412Copy5}>
								<Image style = {stylesheet.styleIcons8People641Copy5} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/cUi5OIs7E2rxgs7ROXSLa5db.png"}}/>
							</View>
						</View>
						<View style = {stylesheet.styleGroup4}>
							...
							<View style = {stylesheet.styleIcons8People6412Copy6}>
								<Image style = {stylesheet.styleIcons8People641Copy6} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/4p2tU8aqA8xyYoJUos5jliRd.png"}}/>
							</View>
						</View>
						<View style = {stylesheet.styleGroup3}>
							...
							<View style = {stylesheet.styleIcons8People6412Copy7}>
								<Image style = {stylesheet.styleIcons8People641Copy7} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/JEsSgYbunOWydWwXMALCVMXl.png"}}/>
							</View>
						</View>
						<Text style = {stylesheet.stylePersonnel}>
							Personnel
						</Text>
						<Image style = {stylesheet.styleIconsExpandArrow3} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/qKDdAGqT5veKuznHQJ04a5sM.png"}}/>
					</View>
					<View style = {stylesheet.styleCargoPanel}>
						...
						<Image style = {stylesheet.styleIconsExpandArrow4} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/oAK4XKSig02pWzW0GafSG7IL.png"}}/>
					</View>
					<View style = {stylesheet.styleCargoPanelCopy1}>
						...
						<Image style = {stylesheet.styleIconsExpandArrow4Copy1} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/cYP1v3Z66bQ44owZpLHizkyi.png"}}/>
					</View>
					...
					<View style = {stylesheet.styleGoBackButton}>
						<Image style = {stylesheet.styleIconsBack1} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/udN5RA1oy29jue9KaKJr1UXN.png"}}/>
						<Text style = {stylesheet.styleGoBack}>
							Go Back 
						</Text>
					</View>
					<View style = {stylesheet.styleTopGroup}>
						<Image style = {stylesheet.styleBatteryIcon} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/oeS5pvhgZ37RDSPvbvB1qxAU.png"}}/>
						<Image style = {stylesheet.styleSignalIcon1} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/ZWxHPQDWyW2ARRNI6JTHftBO.png"}}/>
					...
					<Image style = {stylesheet.styleIcons8Cargo6411} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/G5JYo38ob7QzqjCizm4l4PIP.png"}}/>
					<View style = {stylesheet.styleMenuSearchPanel}>
						<Image style = {stylesheet.styleIcons8Search1201} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/acTOoQKUMQ7hy5HaYNw4XT9l.png"}}/>
						<Text style = {stylesheet.styleDacoApp}>
							DACO APP
						</Text>
						<Image style = {stylesheet.styleIcons8Menu1} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/5ozomNr9lSAlnE0879HxyXy9.png"}}/>
					</View>
