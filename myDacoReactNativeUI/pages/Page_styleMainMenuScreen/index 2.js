...
export const Page_styleMainMenuScreen = ({ route, navigation }) => {
				...
				<View style = {stylesheet.styleStylename}>
					...
					<View style = {stylesheet.styleAirfieldAPanel}>
						...
						<View style = {stylesheet.stylePlaneListing}>
							...
							<Image style = {stylesheet.styleIcons8FighterJet1001} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/syVMs2TOTDcPZ9Qv1elGuHjV.png"}}/>
						...
						<View style = {stylesheet.stylePlaneListingCopy1}>
							...
							<Image style = {stylesheet.styleIcons8FighterJet1001Copy1} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/MvCvQnMaV4YDqipUBQFNslUB.png"}}/>
						...
						<View style = {stylesheet.stylePlaneListingCopy2}>
							...
							<Image style = {stylesheet.styleIcons8FighterJet1001Copy2} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/gbwwTzFxFwSyPb5XwBe4CXyF.png"}}/>
						...
						<View style = {stylesheet.stylePlaneListingCopy3}>
							...
							<Image style = {stylesheet.styleIcons8FighterJet1001Copy3} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/9gptT25pvacOZtxLMZuT72Bm.png"}}/>
						...
						<View style = {stylesheet.stylePlaneListingCopy4}>
							...
							<Image style = {stylesheet.styleIcons8FighterJet1001Copy4} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/RLLGOuD0xy2SscnaObWU1x6h.png"}}/>
						...
						<View style = {stylesheet.styleIcons8Helicopter1001}>
							<Image style = {stylesheet.styleIcons8Helicopter1001Copy1} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/B0YLJW6p3wkLQpvNUeiirsXN.png"}}/>
						</View>
						<View style = {stylesheet.styleIcons8Helicopter1002}>
							<Image style = {stylesheet.styleIcons8Helicopter1001Copy2} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/iWAiFIifEN7eUBJxHPjnjQhe.png"}}/>
						</View>
						<View style = {stylesheet.styleIcons8Helicopter1003}>
							<Image style = {stylesheet.styleIcons8Helicopter1001Copy3} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/ZFX5iEL4ttvBLNwiTTcbpP37.png"}}/>
						</View>
						<View style = {stylesheet.styleIcons8Helicopter1004}>
							<Image style = {stylesheet.styleIcons8Helicopter1001Copy4} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/GfkHpnAdr8dFSFxjcJyYwN5J.png"}}/>
						</View>
						<View style = {stylesheet.styleIcons8Helicopter1005}>
							<Image style = {stylesheet.styleIcons8Helicopter1001Copy5} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/yDbvLbJIlk1o8C7UbHKv1FTB.png"}}/>
						</View>
						<View style = {stylesheet.styleIcons8Helicopter1006}>
							<Image style = {stylesheet.styleIcons8Helicopter1001Copy6} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/URazTRkKdGHvYWVhRtwlwN6a.png"}}/>
						</View>
						<Image style = {stylesheet.styleIconsExpandArrow1} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/WdHqZA2OGndzGrXJNdTKIfOU.png"}}/>
					</View>
					<View style = {stylesheet.stylePersonnelPanel}>
						...
						<View style = {stylesheet.styleIcons8People6411}>
							<Image style = {stylesheet.styleIcons8People641} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/kky4XE2d3JVIzvmQoPxKQqlJ.png"}}/>
						</View>
						<View style = {stylesheet.styleIcons8People6410}>
							<Image style = {stylesheet.styleIcons8People641Copy1} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/z3nF15in9cegBo7808UChRWf.png"}}/>
						</View>
						<View style = {stylesheet.styleIcons8People648}>
							<Image style = {stylesheet.styleIcons8People641Copy2} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/v9820i2uFv3YU8czwgVAsisB.png"}}/>
						</View>
						<View style = {stylesheet.styleIcons8People649}>
							<Image style = {stylesheet.styleIcons8People641Copy3} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/0KfHhrpoeUSX8unA77IyNQFa.png"}}/>
						</View>
						...
						<Image style = {stylesheet.styleIconsExpandArrow2} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/4JgVHlt8LEYswN3FSgQmLHgN.png"}}/>
					</View>
					<View style = {stylesheet.styleMenuSearchPanel}>
						<Image style = {stylesheet.styleIcons8Menu1} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/iF6mSJjh4i9Tz3AScUMyh7wc.png"}}/>
						<Text style = {stylesheet.styleDacoApp}>
							DACO APP
						</Text>
					</View>
					<Image style = {stylesheet.styleIcons8Search1201} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/YyRUhcBawEc7WpwM6wvzttoo.png"}}/>
					<View style = {stylesheet.styleTopGroup}>
						<Image style = {stylesheet.styleBatteryIcon} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/XPK6FddMeMUhTJ72uxWgiLJh.png"}}/>
						<Image style = {stylesheet.styleSignalIcon1} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/LuyWpBrofU0qBEPpifAMXGEe.png"}}/>
					...
					<View style = {stylesheet.stylePlane6}>
						...
						<Image style = {stylesheet.styleIcons8FighterJet1001Copy5} source = {{uri: "https://nyc3.digitaloceanspaces.com/sizze-storage/media/images/LOGnYkI7skc8TV5Ffho0qO2q.png"}}/>
					</View>
				</View>
			</View>
		</ScrollView>
