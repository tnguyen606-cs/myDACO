...
export const Page_styleLoadingBar04 = ({ route, navigation }) => {
	const { signIn, signOut, signUp, authData , resetPassword} = useAuth();
	return (
		<ScrollView style={{width: Dimensions.get("window").width, height: Dimensions.get("window").height, backgroundColor: "rgba(4, 186, 131, 1)"}} horizontal = {false} showsVerticalScrollIndicator={false} showsHorizontalScrollIndicator={false} bounces={false}>
			<View style={{width: Dimensions.get("window").width, height: 786}} >
				<View style = {stylesheet.styleStylename}>
					...
					<Text style = {stylesheet.styleBumpPlanComplete_}>
						Bump Plan Complete!
					</Text>
					<Text style = {stylesheet.styleViewAirfieldManifestChanges}>
						View Airfield Manifest Changes
					</Text>
				</View>
			</View>
		</ScrollView>
...
const stylesheet = StyleSheet.create({
	...
	styleOverlay: {
		...
		height: 128,
		borderRadius: 16,
		backgroundColor: "rgba(8, 238, 127, 1)",
	},
	styleBumpPlanComplete_: {
		position: "absolute",
		left: 63,
		top: 352,
		width: 291,
	...
	styleViewAirfieldManifestChanges: {
		position: "absolute",
		left: 65,
		top: 530,
		width: 273,
	...
	styleStylename: {
		...
		height: 786,
		backgroundColor: "rgba(4, 186, 131, 1)",
	},
